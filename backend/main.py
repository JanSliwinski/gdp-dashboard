...
from backend.fetchers.meteo import fetch_meteo
from backend.fetchers.dam import fetch_dam
from backend.fetchers.market import fetch_ttf, fetch_eua
from backend.fetchers.admie import fetch_admie
